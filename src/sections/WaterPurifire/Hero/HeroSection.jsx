          ...
          <div className="col-xxl-auto col-lg-5 col-md-7 col-sm-8 col-10  transform-none ">
            <div className="home-1_hero-image-block">
              <div className="home-1_hero-image">
                <img
                  src="https://res.cloudinary.com/db1i46uiv/image/upload/v1718353821/Untitled_design_17_pt71fl.png"
                  alt="hero image"
                />
              </div>
            </div>
                ...
                <h1 className="hero-content__title mb-12 primary heading-xxl">
                  {/* <Typewriter
                    options={{
                      ...
                      loop: true,
                      delay: 40,
                      strings: ["Smart", "Lightweight ", "Premium "],
                    }}
                  /> */}
                </h1>
                <h1 className="hero-content__title heading-xxl">
                  <span className="primary pb-2"> Smart Water </span>{" "}
                  Purification System
                </h1>
                <p>
                  Buy with confidence when you choose an Achilles Water Bottle,
                  knowing you’re getting premium quality, durability, and
                  eco-friendly design.{" "}
                </p>
              </div>
